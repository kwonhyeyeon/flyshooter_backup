			...
			<div id="updateData" style="width: 1200px;">
				...
				<form id="recruitUpdateData" name="recruitUpdateData">
					...
					<table class="updateTable">
						...
						<tbody>
							<tr>
								<td><label>신청자명<br /> <input type="text"
										id="m_name" name="m_name" value=" ${updateRecruitData.m_name}"
										disabled>
								</label></td>
							...
							<tr>
								<td><label>연락처<br /> <input type="text"
										name="m_phone1" id="m_phone1" disabled /> <input type="text"
										name="m_phone2" id="m_phone2" disabled /> <input type="text"
										name="m_phone3" id="m_phone3" disabled />
								</label></td>

								<td><label>구장주소<br /> <input type="text"
										name="hr_address" id="hr_address"
							...
							<tr>
								<td><label>매치일자<br /> <input type="text"
										...
										value="${updateRecruitData.hr_m_date}"> <input
										type="text" name="hr_time" id="hr_time"
										value="${updateRecruitData.hr_time}">
								</label></td>
							...
							<tr>
								<td><label>팀 수준<br /> <select name="hr_level"
										id="hr_level">
								...
								<td><label>모집인원<br /> <select name="hr_people"
										id="hr_people">
							...
							<tr>
								<td colspan="2"><label>비고<br /> <textarea
											id="hr_etc" name="hr_etc" rows="5" cols="40">${updateRecruitData.hr_etc}</textarea>
								</label></td>
							</tr>
						</tbody>
					</table>
