...
<body>
		...
		<div id="contents">
			...
			<td>
			<!-- html로 변경하기 -->
			<textarea rows="20" cols="30">제1조(목적)
	본 약관은 FLY_SHOOTER 가 제공하는 모든 서비스의 이용조건 및 절차, 이용자와 당 사이트의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.
	...
	④ 회원은 당 사이트 서비스 이용과 관련하여 다음 각 호의 행위를 하여서는 안됩니다.
	   ...
	   9. 당 사이트에 게시된 정보의 변경
			...
			<td>
			<!-- html로 변경하기 -->
			<textarea rows="20" cols="30">제7조(회원정보 사용에 대한 동의)
