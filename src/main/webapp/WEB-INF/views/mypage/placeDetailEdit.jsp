		...
		<div class="contentTB">
			<form id="p_placeModifyForm" action="/mypage/placeModify.do" method="post">
				<ul>
					<li>
						구장명 
						<input type="text" value="${p_name}" name="p_name" id="p_name">
					</li>
					<li>
						대표자명 
						<input type="text" value="${p_ceo}" name="p_ceo" id="p_ceo">
					</li>
					<li>
						사업자번호 
					...
					<li>
						구장전화번호 
						<input type="text" value="${p_phone}" name="p_phone" id="p_phone">
					</li>
					<li>
						구장 주소 
					...
					<li>
						예금주명
						<input type="text" value="${p_account }"
					...
					<li>
						...
						<div id="p_holidaydate" style="display: none">
							<input type="date" name="p_holiday_start" id="p_holiday_start"/> 
							<input type="date" name="p_holiday_end" id="p_holiday_end"/>
						</div>
						<span id="closePlace"></span>
					</li>
					<li>
						서류 제출 유형 
						<c:choose>
					...
					<li>
						소개글
						<textarea rows="20" cols="50" name="p_intro" id="p_intro">${p_intro}</textarea>
					</li>
				</ul>
				<div>
